...
export const mockWorkflowRecords: WorkflowRecord[] = [
    ...
    step_submissions: [
      {
        ...
        data: { condition: 'good', visualIssues: 'None observed', notes: 'Tree looks healthy' },
  ...
  // Tree 002 - In progress (at step 2)
  {
    ...
    current_step: { id: 'step-detailed-assessment', name: 'Detailed Assessment', order_index: 1 },
    status: 'in_progress',
    step_submissions: [
      {
        step_id: 'step-initial-check',
        data: { condition: 'fair', visualIssues: 'Some yellowing on leaves', notes: 'Needs closer inspection' },
  ...
  // Tree 005 - Not started
  {
    ...
    current_step: { id: 'step-initial-check', name: 'Initial Check', order_index: 0 },
    status: 'not_started',
    step_submissions: [],
    started_at: null,
    completed_at: null,
  ...
  // Equipment 002 - In progress maintenance
  {
    ...
    current_step: { id: 'step-maintenance-work', name: 'Maintenance Work', order_index: 1 },
    status: 'in_progress',
    step_submissions: [
      {
        step_id: 'step-pre-inspection',
        data: { operatingHours: 1250, visualCondition: 'wear', fluidLevels: 'low' },
    ...
    step_submissions: [
      {
        ...
        data: { boundaryIntact: true, fencingCondition: 'good', accessPoints: 2 },
        submitted_at: '2024-03-08T09:00:00Z',
      },
      {
        step_id: 'step-soil-analysis',
        data: { phLevel: 6.8, moistureLevel: 'optimal', nutrientStatus: 'adequate' },
        submitted_at: '2024-03-08T11:00:00Z',
      },
      {
        step_id: 'step-vegetation-survey',
        data: { treeCount: 45, weedPresence: 'light', diseaseIndicators: false },
...
export const mockEntityTypeWorkflows: Record<string, string[]> = {
  'et-palm-tree': ['wf-tree-assessment'],
  'et-plot': ['wf-plot-inspection'],
