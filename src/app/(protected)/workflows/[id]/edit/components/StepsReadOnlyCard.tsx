...
interface StepsReadOnlyCardProps {
  steps: WorkflowStep[];
}

export function StepsReadOnlyCard({ steps }: StepsReadOnlyCardProps) {
  ...
  return (
    <Card className="h-full">
      <CardHeader>
        ...
        <CardDescription>
          Execution order and form configuration (read-only)
        </CardDescription>
      </CardHeader>
      <CardContent>
        {/* Info Banner */}
        <div className="bg-muted/50 mb-6 flex items-start gap-3 rounded-lg border border-dashed p-3">
          <Info className="text-muted-foreground mt-0.5 h-4 w-4 shrink-0" />
          <p className="text-muted-foreground text-sm">
            Workflow steps cannot be modified after creation. To change steps,
